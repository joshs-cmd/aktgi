-- Update catalog_search_deduped to add GL (Gildan/ACC) and HN (Hanes/ACC) prefix stripping
-- plus SP (Sierra Pacific), EC (Econscious) in both brand-specific and cross-brand fallback sections.
